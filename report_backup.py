...
class Report:
    ...
    async def handle_message(self, message):
        ...
        if self.state == State.REPORT_START:
            ...
            # return [{"text": reply, "comp": components}]
            return [reply]
        ...
        if self.state == State.MESSAGE_IDENTIFIED:
            ...
            components = [
                Select(
                    ...
                    options = [
                        SelectOption(label="Hate speech", value="hate"),
                        SelectOption(label="Spam", value="spam")
                    ]
                )
            ]
            # return [reply]
